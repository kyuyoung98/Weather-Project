...
export const AuthContextProvider:React.FC<Props> = (props) => {
  ...
  const signupHandler = (email:string, password: string, name: string, phone:string, address:string) => {
    setIsSuccess(false);
    const response = authAction.signupActionHandler(email, password, name, phone, address);
