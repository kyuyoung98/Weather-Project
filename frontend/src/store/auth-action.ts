...
export const signupActionHandler = (email: string, password: string, name: string, phone:string, address:string) => {
  const URL = '/auth/signup'
  const signupObject = { email, password, name, phone, address };
